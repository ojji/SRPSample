...
{
    public class BuyXItemsGetYDiscountFromPriceStrategyTests
    {
        [Test]
        public void Empty_or_null_itemid_should_throw_ArgumentNullException()
        {
            Assert.DoesNotThrow(() => new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 1, 0.1m));
            Assert.Throws<ArgumentNullException>(() => new BuyXItemsGetYDiscountFromPriceStrategy("", 1, 0.1m));
            Assert.Throws<ArgumentNullException>(() => new BuyXItemsGetYDiscountFromPriceStrategy(null, 1, 0.1m));
        ...
        {
            Assert.DoesNotThrow(() => new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 1, 0.1m));
            Assert.Throws<ArgumentOutOfRangeException>(() => new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 0, 0.1m));
            Assert.Throws<ArgumentOutOfRangeException>(() => new BuyXItemsGetYDiscountFromPriceStrategy("item-1", -1, 0.1m));
        }

        [Test]
        public void Discount_should_be_between_0_and_100_percent()
        {
            Assert.DoesNotThrow(() => new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 4, 0.2m));
            Assert.Throws<ArgumentOutOfRangeException>(() => new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 4, 1.00m));
            Assert.Throws<ArgumentOutOfRangeException>(() => new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 4, 0.00m));
        }
        ...
        public class Matches_item
        {
            ...
            {
                var subject = new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 2, 0.25m);
            ...
            {
                var subject = new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 2, 0.25m);
                var orderitem = new OrderItem { Identifier = "item-1", ItemCost = 20m, Quantity = 1 };
            ...
            {
                var subject = new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 2, 0.25m);
                var orderitem = new OrderItem { Identifier = "item-1", ItemCost = 20m, Quantity = 2 };
                var secondOrderitem = new OrderItem { Identifier = "item-1", ItemCost = 20m, Quantity = 2 };
        ...
        public class Price_calculation
        {
            ...
            {
                var subject = new BuyXItemsGetYDiscountFromPriceStrategy("item-1", 3, 0.25m);
